...
class PointcloudAcronymAndSDFDataset(Dataset):
    ...
    def __init__(self, class_type=['Cup', 'Mug', 'Fork', 'Hat', 'Bottle', 'Bowl', 'Car', 'Donut', 'Laptop', 'MousePad', 'Pencil',
        ...
        self.n_pointcloud = n_pointcloud # 1000
        self.n_density  = n_density # 200
        self.n_occ = n_coords # 1000

        ## Variables on Data
        self.one_object = one_object # False
        self.augmented_rotation = augmented_rotation # True
        self.se3 = se3 # False

        ## Visualization
        self.visualize = visualize # False
        self.scale = 8.
